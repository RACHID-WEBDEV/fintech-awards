                                    ...
                                    <div className="mt-3">
                                        <figure className="group overflow-hidden rounded-md  sm:rounded-2xl sm:rounded-b-[30px]">
                                            <img
                                                ...
                                                width="750px"
                                                height="800px"
                                                className="object-cover bg-contain w-full h-full min-h-[170px] lg:min-h-[750px] rounded-md sm:rounded-xl transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                            ...
                            <div className="relative rounded-md sm:rounded-xl overflow-hidden ">
                                <figure className="group overflow-hidden rounded-md sm:rounded-2xl sm:rounded-b-[30px]">
                                    ...
                                    <img
                                        ...
                                        className="object-cover w-full h-full lg:min-h-[510px] rounded-md sm:rounded-xl transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
                            ...
                            <div className="relative rounded-md sm:rounded-xl overflow-hidden hidden sm:block">
                                <figure className="group overflow-hidden rounded-md sm:rounded-2xl sm:rounded-b-[30px]">
                                    <img
                                        ...
                                        className="object-cover w-full h-full rounded-md lg:min-h-[510px] sm:rounded-xl transition-transform duration-[1600ms] will-change-transform group-hover:scale-105"
